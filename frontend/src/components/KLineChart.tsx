...
const OPT = {
  ...
  grid: { top: 30, right: 20, bottom: 22, left: 65 },
...
type Props = { symbol?: string; freq?: string; data?: KLineRow[]; refreshKey?: number };
...
export function KLineChart(props: Props) {
  ...
  }, [symbol, freq, days, agg, controlled, props.refreshKey]);
